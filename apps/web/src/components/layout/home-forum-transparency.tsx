  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
      ...
      <aside className="surface-glass card-lift rounded-[1.875rem] p-7 sm:p-8">
        <span className="text-sm font-extrabold tracking-wide text-[#43515d]">
...
function TransparencyItem({
  ...
  return (
    <li className="grid grid-cols-[42px_1fr] gap-3.5">
      ...
      <div>
        <strong className="block text-[0.98rem] font-extrabold text-foreground">
          {title}
        </strong>
...
function ScaleIcon() {
  return (
    ...
    >
      <path
        d="M12 3v18M5 8h14M7 8l-2 6h4L7 8zm10 0l-2 6h4l-2-6z"
        strokeLinecap="round"
