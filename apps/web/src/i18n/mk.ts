...
export const mk = {
  ...
  home: {
    ...
    howStep1Body:
      "Пребарајте лекари, установи, аптеки и производи на едно место.",
    howStep2Title: "Споредете информации",
    howStep2Body:
      "Користете филтри и јавни податоци за локација, услуги и референтни цени.",
    howStep3Title: "Читајте рецензии",
    howStep3Body:
      "Рецензиите се модерирани; третирајте ги како дополнителен сигнал, не како дијагноза.",
  ...
  auth: {
    ...
    resetPasswordFailed:
      "Лозинката не може да се промени. Обидете се повторно.",
  ...
  account: {
    ...
    profilePhotoUnlocked:
      "Прикачете JPG, PNG или WebP (се зачувува како WebP).",
    ...
    hubHeroDescription:
      "Управувајте со профилот, рецензиите и форум активноста.",
    reviewsHeroDescription:
      "Преглед на вашите рецензии и нивниот статус на модерација.",
    forumHeroDescription:
      "Теми и одговори што сте ги испратиле — вклучувајќи ги и оние на чекање.",
  },
  doctors: {
    title: "Лекари",
    description:
    ...
    trustRatingsInfo:
      "Оценките се дополнителен сигнал, не медицинска препорака.",
  ...
  facilities: {
    title: "Установи",
    description:
      "Клиники, болници и лаборатории. Аптеките се во посебен директориум.",
    ...
    mapCoordinatesMissing:
      "Немаме координати — отворете ја локацијата на мапа.",
  ...
  pharmacies: {
    ...
    resultsTitle: "Резултати",
    trustPricesInfo:
      "Референтните цени се информативни — проверете во аптеката.",
  ...
  products: {
    ...
    offersTruncated:
      "Прикажани се {shown} од {total} аптеки. Погледнете поединечни страници на аптеки за целосна листа.",
  },
  reviews: {
    summary: "Рецензии",
    count: "рецензии",
    ...
    pendingBody:
      "Ја примивме вашата рецензија. Ќе се појави јавно откако ќе ја одобри нашиот тим.",
    sortNewest: "Најнови",
    sortOldest: "Најстари",
  ...
  about: {
    ...
    ctaBody:
      "Прочитајте го ограничувањето на одговорност пред да користите содржина од платформата.",
  },
  disclaimerPage: {
    badge: "Одрекување",
  ...
  forum: {
    ...
    newTopicPageDescription:
      "Испратете тема за модерација пред да биде јавно видлива.",
    ...
    consentEmergency:
      "При итност ќе повикам 194/112, не ќе чекам одговор на форумот.",
    ...
    loginCtaBody:
      "Членовите можат да отворат теми и да одговараат по модерација.",
