...
return [
    ...
    'auth' => [
        'invalid_credentials' => 'Внесените податоци за најава не се точни.',
        'logged_out' => 'Одјавени сте.',
        'registration_pending' => 'Ако е-адресата може да се користи, испративме порака со следниот чекор. Проверете го вашето сандаче.',
